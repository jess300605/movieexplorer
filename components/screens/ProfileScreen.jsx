  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingItem}>
          <View style={styles.settingInfo}>
            ...
            <Text style={styles.settingText}>Adult Content</Text>
          </View>
          <Switch
            trackColor={{ false: "#767577", true: "#81b0ff" }}
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.menuItem}>
          <View style={styles.menuInfo}>
            ...
            <Text style={styles.menuText}>About Movie Explorer</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color="#999" />
        </TouchableOpacity>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>Movie Explorer v1.0.0</Text>
        <Text style={styles.footerText}>Powered by TMDB API</Text>
      </View>
    </ScrollView>
  )
}
