...
export default function DetailsScreen() {
  ...
  const fetchMovieDetails = async () => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/movie/${id}?api_key=${API_KEY}&language=en-US&append_to_response=credits,videos`,
      )
  ...
  const toggleFavorite = () => {
    ...
    // In a real app, you would save this to storage or an API
  }
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.section}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.castContainer}>
            {movie.credits.cast.length > 0 ? renderCast() : <Text>No cast information available.</Text>}
          </ScrollView>
        </View>
